 ...
 * @OA\Property(property="password", type="string", readOnly="true", format="password", description="User unique email address", example="user@gmail.com"),
